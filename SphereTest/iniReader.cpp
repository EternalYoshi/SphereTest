...
float CIniReader::ReadFloat(const char* szSection, const char* szKey, float iDefaultValue)
{
	float iResult = GetPrivateProfileIntA(szSection, szKey, iDefaultValue, m_szFileName);
	return iResult;
}